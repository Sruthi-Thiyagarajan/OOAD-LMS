...
StartWidget::StartWidget(QWidget *parent) : QLabel(parent)
{
    ...
    this->pixMap =new QPixmap(QCoreApplication::applicationDirPath()+"/../../OOAD-LMS/background/bg1.jpg");
...
void StartWidget::initButtons()
{
    ...
    this->loginBtn= QIcon(QCoreApplication::applicationDirPath()+"/../../OOAD-LMS/icons/login.jpg");
    this->signupBtn = QIcon (QCoreApplication::applicationDirPath()+"/../../OOAD-LMS/icons/signup.jpg");
